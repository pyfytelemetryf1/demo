        ...
        slides: [
            ...
            },
            {
                markdown: '<p><strong>PyFy Telemetry F1</strong> is currently compatible with EA Sports F1 25*.</p>' +
                    ...
                    '<p class="welcome-slide-cta">\u2026or select another <a href="#" class="slide-open-drawer">walkthrough</a> from the menu,<br/>or get it free in the <a href="https://apps.microsoft.com/detail/9P60JSFXGLG0" target="_blank" rel="noopener" class="slide-link welcome-store-link">Microsoft Store</a>.</p>' +
